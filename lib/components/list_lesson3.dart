...
class ListLesson3 extends StatefulWidget {
  const ListLesson3({super.key});

  @override
  State<ListLesson3> createState() => _ListLesson3State();
}

class _ListLesson3State extends State<ListLesson3> {
  final List<Map<String, String>> lessons = [
    {
      'image': 'assets/file.png',
      'title': 'Lesson C-TPAT 1',
