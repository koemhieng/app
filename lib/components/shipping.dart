...
class Shipping extends StatelessWidget {
  ...
  // Function to handle routing dynamically
  void _navigateToPage(BuildContext context, String pageTitle) {
    // Use GetX to navigate to different pages based on the title or any other parameter
    switch (pageTitle) {
      case 'Videos Course':
        Get.to(Homepage(title: pageTitle)); // Navigate to the Homepage with a specific title
        break;
      case 'Lesson (PDF)':
        Get.to(Lesson()); // Example: Navigate to Homepage for Lessons
        break;
      case 'Activity':
        // Get.to(Homepage(title: pageTitle)); // Example: Navigate to Homepage for Activity
        break;
      default:
        Get.to(Homepage(title: "Default Page")); // Default case if no match
    }
  }
                  ...
                  builder: (context, setState) {
                    ...
                    return GestureDetector(
                      ...
                      onTap: () {
                        ...
                        _navigateToPage(context, items[index]['text'] as String);
                      },
                      child: AnimatedScale(
                        scale: scale,
